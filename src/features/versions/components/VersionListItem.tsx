...
export function VersionListItem({ version, onClick }: Props) {
  ...
  return (
    <div
      className={`cursor-pointer flex flex-col gap-y-4 rounded-lg border p-3 transition-all hover:border-muted-foreground/50 hover:bg-white ${version.isCurrent ? 'border-blue-500 bg-blue-50' : 'border-muted-foreground/30 '} `}
